<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item">
				<a class="nav-link" href="/exercicios" id="help" aria-haspopup="true" aria-expanded="false">Listar Exercicios</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="/exercicios/create" id="help" aria-haspopup="true" aria-expanded="false">Criar Exercicios</a>
			</li>
		</ul>
